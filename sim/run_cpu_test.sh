...
# run_cpu_test.sh - CPU Execution Test Simulation
#
...
vlog -work work -sv tb_cpu_run.sv

# Run simulation
echo "Running CPU run test simulation..."
vsim -c -do "run -all; quit" work.tb_cpu_run
