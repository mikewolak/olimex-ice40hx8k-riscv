...
# run_r_test.sh - Shell 'r' Command Test Simulation
#
...
vlog -work work -sv tb_r_command.sv

# Run simulation
echo "Running 'r' command test simulation..."
vsim -c -do "run -all; quit" work.tb_r_command
